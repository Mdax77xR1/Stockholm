...
client.on('ready', () => {
   ...
   client.user.setActivity("",{type: 'watching'})
    ...
    console.log('')
    console.log('╔[════════════]╗')
    console.log(' D.Papel Gang BOT Is Online')
    console.log('╚[════════════]╝')
    console.log('')
    console.log('')
  });
        ...
        ///////////////////////
            ...
            client.on('message', message => {
                if (message.content.startsWith('$D.Papel-info')){
                     ...
                     .addField('Owner Of The Gang :',"IGN : __ So0n __ | Discord : So0n ")            
                     .addField(`Co.Owner OF The Gang : `, "IGN : __ So0n __  | Discord : So0n ")
                     .addField("Count Of Gang Members  :",`__ So0n __`)
                     .addField("Names Of Gang Members  : So0n ",`
                     1- 
                     2- 
                     3- 
                     4- 
                     ...
                     14- 
                     15- So0n`)
                     .addField("Faction Name :",`__ D.Papel __`)
                     .setFooter('Made By | ✈ MdĄx7ź ♛ .#8085  | ')
